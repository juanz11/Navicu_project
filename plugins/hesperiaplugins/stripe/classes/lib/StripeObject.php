...
use HesperiaPlugins\Stripe\classes\lib\Util\Util;
use HesperiaPlugins\Stripe\Classes\lib\util\Set;
use HesperiaPlugins\Stripe\classes\lib\Util\RequestOptions;
//\HesperiaPlugins\Stripe\Classes\lib\Util\
//~
/**
 * Class StripeObject
 *
...
class StripeObject implements ArrayAccess, JsonSerializable
{
    ...
    {
        self::$permanentAttributes = new Set(array('_opts', 'id'));
    ...
    {
        $this->_opts = $opts ? $opts : new RequestOptions();
        $this->_values = array();
    ...
    public function refreshFrom($values, $opts, $partial = false)
    {
        ...
        foreach ($values as $k => $v) {
            ...
            if (self::$nestedUpdatableAttributes->includes($k) && is_array($v)) {
                ...
                $this->_values[$k] = Util::convertToStripeObject($v, $opts);
            }

...
namespace HesperiaPlugins\Stripe\Classes\lib\HttpClient;

use HesperiaPlugins\Stripe\Classes\lib\Stripe;
use HesperiaPlugins\Stripe\Classes\lib\Error;
...
class CurlClient implements ClientInterface
{
    ...
    public function request($method, $absUrl, $headers, $params, $hasFile)
    {
        ...
        if ($method == 'get') {
            ...
            $opts[CURLOPT_POST] = 1;
            $opts[CURLOPT_POSTFIELDS] = $hasFile ? $params : Util::urlEncode($params);
